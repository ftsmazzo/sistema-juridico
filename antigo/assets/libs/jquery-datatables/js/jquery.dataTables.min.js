...
fnStateLoaded:null,fnStateSaveCallback:function(a,b){try{(-1===a.iStateDuration?sessionStorage:localStorage).setItem("DataTables_"+a.sInstance+"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": ordenação crescente ativada na coluna",sSortDescending:": ordenação decrescente ativada na coluna"},oPaginate:{sFirst:"Primeira",sLast:"Última",sNext:"Próximo",sPrevious:"Anterior"},
sEmptyTable:"Sem dados disponíveis na tabela",sInfo:"Mostrando _START_ até _END_ de um total de _TOTAL_",sInfoEmpty:"Sem registro",sInfoFiltered:"(filtrado de _MAX_ registros)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Mostrando _MENU_ registros",sLoadingRecords:"Carregando...",sProcessing:"Processando...",sSearch:"Pesquisar:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Sem resultados encontrados"},oSearch:h.extend({},p.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",sPaginationType:"simple_numbers",
