...

{
  ...
  "prazoDiasUteisSugerido": número em dias úteis do prazo legal/fatal quando o texto indicar prazo específico; use 0 se não houver prazo expresso (o sistema aplicará 5 dias úteis internamente),
...
- prazoDiasUteisSugerido: use o prazo que o texto indicar (ex.: 10, 15 dias úteis). Intimação para contestar/manifestar com prazo legal explícito costuma ser 15. Se não houver prazo específico (ex.: apenas ciência, convocar para falar de petição), use 0 — o sistema contará 5 dias úteis (fatal) e exibirá alerta com 3 dias úteis.
