...
| `EMAIL_MONITOR_ENCRYPTION_KEY` | Não (monitoramento de e-mail) | `openssl rand -hex 32` (64 caracteres) | Chave para criptografar a senha da conta IMAP em **Monitoramento de e-mail**. Obrigatória se configurar uma conta com senha. |
